...
This repository is a fork of [karpathy/autoresearch](https://github.com/karpathy/autoresearch) maintained by **OneByJorah**.

**Changes from upstream:**
- Added `Dockerfile` (python:3.11-slim with uv) for containerized training
- Added `docker-compose.yml` with GPU support
- Added `.env.example` with training configuration options
